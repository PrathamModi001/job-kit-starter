...
- **Experience Level:** Postings gated at 0–2 YOE or 0–3 YOE. Skip roles requiring 4+ YOE or Senior/Staff/Principal/Architect/Lead titles.
...
- **Single Source of Truth:** `job-kit-starter/output/job-search/applications.csv`. Always check to prevent duplicate outreach.
